...
class Client(Node):
    ...
    def initialize(self):
        ...
        if self.args.federated_type == 'fedaq':
            self.args.optimizer = 'asgd'
    ...
    def gen_aux_models(self):
        if self.args.federated:
            ...
            elif self.args.federated_type == 'fedaq':
                self.model_ag = deepcopy(self.model)
                self.model_server_ag = deepcopy(self.model)
