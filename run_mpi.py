...
def main(args):
    ...
    mlp_size = {'mnist':200,'fashion_mnist':200,'cifar10':500,'cifar100':500,'adult':50,'MSD':50,'emnist':200, 'emnist_full':200}
    NUM_NODES=1
    ...
    prefix_cmd = 'mpirun -np {} --allow-run-as-root --bind-to core --oversubscribe --mca btl_tcp_if_exclude docker0,lo --mca orte_base_help_aggregate 0 \
...
if __name__ == "__main__":
  ...
  parser.add_argument('-ld', '--lr_gamma_decay', default=1.01, type=float)
  ...
  parser.add_argument('-lb', '--lambd', default=1e-3, type=float)
